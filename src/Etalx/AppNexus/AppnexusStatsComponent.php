...
class AppnexusComponent {
	...
	private	$_apiUrl = "http://api.appnexus.com";
	...
	private function _getReport(){
		curl_setopt($this->_curl, CURLOPT_URL, $this->_apiUrl . self::URL_REPORT . "?report_type=pixel_fired");
		$result = curl_exec($this->_ch);
		Iw_Util::debug(json_decode($result, true), '_getReport');
	}
